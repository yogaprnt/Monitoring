...
@php
    ...
    $dashboardRoute = 'asisten_manager.dashboard';
    $approvalRoute  = 'asisten_manager.approve';
    $approveRoute   = 'asisten_manager.item.approve';
    $rejectRoute    = 'asisten_manager.item.reject';
...
<div class="content">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-2xl border border-gray-250 shadow-sm overflow-hidden">
                <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-150">
                    <div class="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-400">
