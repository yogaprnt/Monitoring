...
@section('title', 'Kinerja Akademik - RI CCSL')
...
<div class="content">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Kinerja Akademik</h1>
        <p class="text-gray-500 text-sm mt-1">Kelola data akademik yang sedang berjalan maupun direncanakan</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 px-6 py-4 mb-4">
        <div class="flex items-center justify-between mb-4">
            <span class="font-semibold text-gray-700">{{ $isEdit ? 'Edit Akademik' : 'Tambah Kinerja Akademik Baru' }}</span>
            @if(!$isEdit)
        ...
        <div id="formTambah" class="{{ $isEdit || $errors->any() ? '' : 'hidden' }}">
            <form action="{{ $isEdit ? route('akademik.update', $item->id) : route('akademik.store') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Judul Akademik</label>
                        <select name="judul" required
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#1a2e4a]">
                            <option value="">-- Pilih Judul Akademik --</option>
    ...
    {{-- TABEL DAFTAR AKADEMIK --}}
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="font-semibold text-gray-700">Data Kinerja Akademik</h2>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-[#1a2e4a] text-white text-xs uppercase tracking-wider">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left font-medium">Judul Akademik</th>
                        ...
                        <td class="px-6 py-4">
                            @if($data->canBeModifiedByStaff())
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('akademik.edit', $data->id) }}"
