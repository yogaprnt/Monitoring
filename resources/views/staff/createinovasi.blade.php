...
@section('title', 'Kinerja Inovasi - RI CCSL')
...
<div class="content">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Kinerja Inovasi</h1>
        <p class="text-gray-500 text-sm mt-1">Kelola data inovasi yang sedang berjalan</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 px-6 py-4 mb-4">
        <div class="flex items-center justify-between mb-4">
            <span class="font-semibold text-gray-700">{{ $isEdit ? 'Edit Inovasi' : 'Tambah Inovasi Baru' }}</span>
            @if(!$isEdit)
        ...
        <div id="formTambah" class="{{ $isEdit || $errors->any() ? '' : 'hidden' }}">
            <form action="{{ $isEdit ? route('inovasi.update', $item->id) : route('inovasi.store') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Judul Inovasi</label>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="font-semibold text-gray-700">Data Kinerja Inovasi</h2>
        </div>
                ...
                <tbody class="divide-y divide-gray-50">
                        ...
                        <td class="px-6 py-4">
                            @if($data->canBeModifiedByStaff())
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('inovasi.edit', $data->id) }}"
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-10 text-center text-gray-400">
                            <i class="fas fa-lightbulb text-3xl mb-2 block text-gray-300"></i>
